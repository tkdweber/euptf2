...
vignette: >
  %\VignetteIndexEntry{R package of updated European hydraulic pedotransfer functions (euptf2)}
...
if (!require(euptf2)){devtools::install_github("tkdweber/euptf2"));library(euptf)}

=======
if (!require(devtools)){install.packages("devtools")}
if (!require(euptf2)){devtools::install_github("tkdweber/euptf2")}
>>>>>>> cf682055c4f278cf7d65914ea96d1f7e5f1da48a
```
